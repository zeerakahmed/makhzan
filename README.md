...
Details of how the text is structured are below. For more information on how the scripts function, step into [documentation in the `/scripts` directory](/tree/master/scripts/).
